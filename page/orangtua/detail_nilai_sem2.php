...
if(isset($_SESSION['login'])){ 
    ...
    $sql = "SELECT  tbl_nilai.pkn,tbl_nilai.bindo,tbl_nilai.mtk,tbl_nilai.ipa,tbl_nilai.ips,tbl_nilai.sbdp,tbl_nilai.pjok,tbl_siswa.nama_siswa,tbl_nilai.semester,tbl_nilai.S,tbl_nilai.I,tbl_nilai.A FROM tbl_nilai,tbl_siswa WHERE tbl_nilai.nis = tbl_siswa.nis AND tbl_siswa.nis = '$user' AND tbl_nilai.semester = 'Semester 2'";
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <?php $err ="<div class='alert alert-warning' role='alert'>Nilai Masih Kosong</div>";?>
